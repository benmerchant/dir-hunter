 ...
 * @fileoverview import fs & path Node modules
 * for now, you must start searching in the current
 * working directory
 ...
 */
'use strict';
/** // TODO: allow user to enter path to a dir location other than current working dir
  *          most likely via command line for first fully functional module
  *          not difficult. Just outside the scope of this iteration.
  */
/**
...
const FileDE = require('./dirents/file.direntry'),
      DirectoryDE = require('./dirents/directory.direntry');
/**
